        ...
        if(isset($_GET['IdAsignatura']) && isset($_GET['IdGrado'])){
            ...
            <div class="col-xl-6 col-lg-8 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <?php
                  $access = new es\ucm\FormLaboratorio('idLaboratorio');
                ...
                $context = new es\ucm\Context(FIND_LABORATORIO, htmlspecialchars(trim(strip_tags($_GET[$name]))));
                  ...
                  if($contextLaboratorio->getEvent() === FIND_LABORATORIO_OK ){
                    $datosIniciales['Creditos']=$contextLaboratorio->getData()->getCreditos();
                    $datosIniciales['Presencial']=$contextLaboratorio->getData()->getPresencial();
