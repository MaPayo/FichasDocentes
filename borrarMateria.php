...
<head>
    ...
    ?>
    <title>Gestion Docente: Materia</title>
</head>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if ($contextMateria->getEvent() === FIND_MATERIA_OK) {
                                    $contextMateria->getData()->setActivo(0);
                  
                                    $context = new es\ucm\Context(DELETE_MATERIA, $contextMateria->getData());
                                    $contextDA = $controller->action($context);
                                   if ($contextDA->getEvent() === DELETE_MATERIA_OK) {
                                        header('Location: gestionGrados.php');
                                    } elseif ($contextDA->getEvent() === DELETE_MATERIA_FAIL) {
