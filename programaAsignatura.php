                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_GET['IdAsignatura'])) {
                                ...
                                $context = new es\ucm\Context(FIND_MODPROGRAMA_ASIGNATURA, htmlspecialchars(trim(strip_tags($_GET['IdModAsignatura']))));
                            }
                            ...
                            if ($contextPrograma->getEvent() === FIND_PROGRAMA_ASIGNATURA_OK || FIND_MODPROGRAMA_ASIGNATURA_OK) {
                                ...
                                $datosIniciales['programaDetallado'] = $contextPrograma->getData()->getProgramaDetallado();
                                $datosIniciales['programaDetalladoI'] = $contextPrograma->getData()->getProgramaDetalladoI();
                                $datosIniciales['idAsignatura'] = $contextPrograma->getData()->getIdAsignatura();
                                $access->gestionaModificacion($datosIniciales);
                            } elseif ($contextPrograma->getEvent() === FIND_PROGRAMA_ASIGNATURA_FAIL || FIND_MODPROGRAMA_ASIGNATURA_FAIL) {
