                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            if(isset($_GET['IdAsignatura'])){
                                ...
                                $context = new es\ucm\Context(FIND_MODBIBLIOGRAFIA, htmlspecialchars(trim(strip_tags($_GET['IdModAsignatura']))));
                            }
                            ...
                            }elseif($contextBibliografia->getEvent() === FIND_BIBLIOGRAFIA_FAIL || FIND_MODBIBLIOGRAFIA_FAIL){
