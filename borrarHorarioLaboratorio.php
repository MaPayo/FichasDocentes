    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center align-items-center">
            ...
            if (isset($_SESSION['login']) && $_SESSION['login'] === true) {
                ...
                if (isset($_GET['IdGrado']) && isset($_GET['IdAsignatura']) && isset($_GET['IdHorarioLaboratorio'])) {
                            ...
                            <div class="col-md-6 col-12">
                                <div class="card ">
                                    <div class="card-header text-center">
                                        <h2>Eliminar un horario de un grupo de laboratorio</h2>
                                    </div>
                                    <div class="card-body text-center">
                                        ...
                                        if (isset($_GET['Confirmacion']) && $_GET['Confirmacion'] === 'y') {
                                            if (isset($_GET['IdHorarioLaboratorio'])) {
                                                ...
                                                if ($contextHorarioLaboratorio->getEvent() === FIND_MODHORARIO_LABORATORIO_OK) {
                                                    $context = new es\ucm\Context(DELETE_MODHORARIO_LABORATORIO, $IdHorarioLaboratorio);
                                                    $contextHorarioLaboratorio = $controller->action($context);
                                        ...
                                        ?>
                                            ¿Estás seguro de que quieres eliminar el horario del grupo de laboratorio?
                                            <div class="text-center">
                                                ...
                                                <a href="borrarHorarioLaboratorio.php?IdGrado=<?php echo $IdGrado; ?>&IdAsignatura=<?php echo $IdAsignatura; ?>&IdHorarioLaboratorio=<?php echo $IdHorarioLaboratorio; ?>&Confirmacion=y">
