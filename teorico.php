...
<head>
  ...
  ?>
  <title>Gestión Docente: Teórico</title>
</head>
            ...
            <div class="col-md-6 col-12">
              <div class="card">
                <div class="card-header text-center">
                  <h2>Crear/Modificar Teorico</h2>
                </div>
                <div class="card-body">
                  <?php
                  $access = new es\ucm\FormTeorico('idTeorico');
                ...
                $context = new es\ucm\Context(FIND_TEORICO, htmlspecialchars(trim(strip_tags($_GET[$name]))));
                  ...
                  if($contextTeorico->getEvent() === FIND_TEORICO_OK ){
                    $datosIniciales['Creditos']=$contextTeorico->getData()->getCreditos();
                    $datosIniciales['Presencial']=$contextTeorico->getData()->getPresencial();
