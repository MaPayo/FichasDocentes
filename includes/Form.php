...
class Form
{
   ...
   *
   * @param string $action (opcional) URL asociada al atributo "action" de la etiqueta <form> del formulario y que procesará el envío del formulario. Por defecto la URL es $_SERVER['PHP_SELF']
   *
  ...
  public function __construct($formId, $opciones = array() )
  {
    ...
    /**
     * Funciones que se encarga de la gestion del formulario
     */
  ...
  /**
   * Se encarga de filtrar los datos de formulario
   */
  protected function clean($dato){
