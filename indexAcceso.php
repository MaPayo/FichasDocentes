...
<body>
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <?php
            if (isset($_SESSION['login']) && $_SESSION['login'] === true && isset($_GET['IdAsignatura']) && isset($_SESSION['permisos'][$_GET['IdAsignatura']])) {
            ...
            ?>
                ...
                <div class="col-md-8 col-12">
                    <div class="card ">
                        <div class="card-header text-center">
                            <?php
                            echo '<h2>Información docente de <b>' . $asignatura->getNombreAsignatura() . '</b></h2>';
                            ?>
                        </div>
                        <div class="card-body">
                            <nav>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                Creditos: ' . $asignatura->getCreditos() . '<br />
                                        ...
                                        <table class="table table-sm table-hover table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <?php
                                                    $horasTotales = ($teorico->getCreditos() * 25 * $teorico->getPresencial()) / 100; //corregir
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    $horasTotales = ($problema->getCreditos() * 25 * $problema->getPresencial()) / 100; //corregir
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    $horasTotales = ($laboratorio->getCreditos() * 25 * $laboratorio->getPresencial()) / 100; //corregir
                                ...
                                <div class="tab-pane fade" id="nav-prog-asignatura" role="tabpanel" aria-labelledby="nav-prog-asignatura-tab">
                                    <div class="accordion" id="accordionProgram">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getConocimientosPrevios() == 1) { ?>
                                            <div class="card">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getBreveDescripcion() == 1) { ?>
                                            <div class="card">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getProgramaDetallado() == 1) { ?>
                                            <div class="card">
                                    ...
                                    <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoPrograma() >= 6) {
                                        if ($contextModPrograma->getEvent() === FIND_MODPROGRAMA_ASIGNATURA_OK) { ?>
                                            <a href="programaAsignatura.php?IdModAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                <button type="button" class="btn btn-primary" id="btn-form">
                                                    Modificar Borrador Programa Asignatura
                                                </button>
                                            </a>
                                        <?php } ?>
                                        <a href="programaAsignatura.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                            <button type="button" class="btn btn-primary" id="btn-form">
                                                Crear Nuevo Borrador Programa Asignatura
                                            </button>
                                        </a>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="tab-pane fade" id="nav-comp-asignatura" role="tabpanel" aria-labelledby="nav-comp-asignatura-tab">
                                    <div class="accordion" id="accordionCompetencia">
                                        ...
                                        <!-- Pestaña generales -->
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getComGenerales() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingOne">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        ...
                                        <!-- Pestaña especificas -->
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getComEspecificas() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingThree">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getComBasicas() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingFive">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getResultadosAprendizaje() == 1) { ?>
                                            <div class="card">
                                    ...
                                    <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoCompetencias() >= 6) {
                                        if ($contextModCompetencias->getEvent() === FIND_MODCOMPETENCIAS_ASIGNATURA_OK) { ?>
                                            <a href="competenciasAsignatura.php?IdModAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                <button type="button" class="btn btn-primary" id="btn-form">
                                                    Modificar Borrador Competencias Asignatura
                                                </button>
                                            </a>
                                        <?php } ?>
                                        <a href="competenciasAsignatura.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                            <button type="button" class="btn btn-primary" id="btn-form">
                                                Crear Nuevo Borrador Competencias Asignatura
                                            </button>
                                        </a>
                                    <?php } ?>
                                </div>
                                ...
                                <!--Pestaña metodologia-->
                                <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getMetodologia() == 1) { ?>
                                    <div class="tab-pane fade" id="nav-metodologia" role="tabpanel" aria-labelledby="nav-metodologia-tab">
                                        ...
                                        <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoMetodologia() >= 6) {
                                            if ($contextModMetodologia->getEvent() === FIND_MODMETODOLOGIA_OK) { ?>
                                                <a href="metodologia.php?IdModAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                    <button type="button" class="btn btn-primary" id="btn-form">
                                                        Modificar Borrador Metodología
                                                    </button>
                                                </a>
                                            <?php } ?>
                                            <a href="metodologia.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                <button type="button" class="btn btn-primary" id="btn-form">
                                                    Crear Nuevo Borrador Metodología
                                                </button>
                                            </a>
                                        <?php } ?>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="nav-bibliografia" role="tabpanel" aria-labelledby="nav-bibliografia-tab">
                                    <div class="accordion" id="accordionBibliografia">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getCitasBibliograficas() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingOne">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getRecursosInternet() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingTwo">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    ...
                                    <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoBibliografia() >= 6) {
                                        if ($contextModBibliografia->getEvent() === FIND_MODBIBLIOGRAFIA_OK) { ?>
                                            <a href="bibliografia.php?IdModAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                <button type="button" class="btn btn-primary" id="btn-form">
                                                    Modificar Borrador Bibliografía
                                                </button>
                                            </a>
                                        <?php } ?>
                                        <a href="bibliografia.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                            <button type="button" class="btn btn-primary" id="btn-form">
                                                Crear Nuevo Borrador Bibliografía
                                            </button>
                                        </a>
                                    <?php } ?>
                                </div>
                                ...
                                <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getGrupoLaboratorio() == 1) { ?>
                                    <div class="tab-pane fade" id="nav-grupo-laboratorio" role="tabpanel" aria-labelledby="nav-grupo-laboratorio-tab">
                                                                    ...
                                                                    <div class="card-header" id="heading<?php echo $grupo->getIdGrupoLab() ?>">
                                                                        <h2 class="mb-0">
                                                                            <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapse<?php echo $grupo->getIdGrupoLab() ?>" aria-expanded="true" aria-controls="collapse<?php echo $grupo->getIdGrupoLab() ?>">
                                                                                ...
                                                                                if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoGrupoLaboratorio() >= 6) { ?>
                                                                                    <a href="grupoLaboratorio.php?IdGrupoLaboratorio=<?php echo $grupo->getIdGrupoLab(); ?>">
                                                                                        <button type="button" class="btn btn-primary" id="btn-form">
                                                                                            Modificar Grupo
                                                                                        </button>
                                                                                    </a>
                                        ...
                                        <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoGrupoLaboratorio() >= 6) { ?>
                                            <a href="grupoLaboratorio.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                <button type="button" class="btn btn-primary" id="btn-form">
                                                    Crear Nuevo Grupo
                                                </button>
                                            </a>
                                ...
                                <div class="tab-pane fade" id="nav-grupo-clase" role="tabpanel" aria-labelledby="nav-grupo-clase-tab">
                                                                ...
                                                                <div class="card-header" id="heading<?php echo $grupo->getIdGrupoClase() ?>">
                                                                    <h2 class="mb-0">
                                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapse<?php echo $grupo->getIdGrupoClase() ?>" aria-expanded="true" aria-controls="collapse<?php echo $grupo->getIdGrupoClase() ?>">
                                                                            <?php echo $grupo->getLetra();
                                                                            if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoGrupoClase() >= 6) { ?>
                                                                                <a href="grupoClase.php?IdGrupoClase=<?php echo $grupo->getIdGrupoClase(); ?>">
                                                                                    <button type="button" class="btn btn-primary" id="btn-form">
                                                                                        Modificar Grupo
                                                                                    </button>
                                                                                </a>
                                    ...
                                    <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoGrupoClase() >= 6) { ?>
                                        <a href="grupoClase.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                            <button type="button" class="btn btn-primary" id="btn-form">
                                                Crear Nuevo Grupo
                                            </button>
                                        </a>
                                ...
                                <div class="tab-pane fade" id="nav-evaluacion" role="tabpanel" aria-labelledby="nav-evaluacion-tab">
                                    <div class="accordion" id="accordionEvaluacion">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getRealizacionExamenes() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingOne">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getCalificacionFinal() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingThree">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getRealizacionActividades() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingFive">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        ...
                                        <?php if ($contextConfiguacion->getEvent() === FIND_CONFIGURACION_OK && $contextConfiguacion->getData()->getRealizacionLaboratorio() == 1) { ?>
                                            <div class="card">
                                                <div class="card-header" id="headingSeven">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link text-dark collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                    ...
                                    <?php if (unserialize($_SESSION['permisos'][$asignatura->getIdAsignatura()])->getPermisoEvaluacion() >= 6) {
                                        if ($contextModEvaluacion->getEvent() === FIND_MODEVALUACION_OK) { ?>
                                            <a href="evaluacion.php?IdModAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                                <button type="button" class="btn btn-primary" id="btn-form">
                                                    Modificar Borrador Evaluación
                                                </button>
                                            </a>
                                        <?php } ?>
                                        <a href="evaluacion.php?IdAsignatura=<?php echo $asignatura->getIdAsignatura(); ?>">
                                            <button type="button" class="btn btn-primary" id="btn-form">
                                                Crear Nuevo Borrador Evaluación
                                            </button>
                                        </a>
                                    <?php } ?>
                                </div>
