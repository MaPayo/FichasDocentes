            ...
            <div class="col-md-6 col-12">
              <div class="card">
                <div class="card-header text-center">
                  <h2>Crear/Modificar Problema</h2>
                </div>
                <div class="card-body">
                  <?php
                  $access = new es\ucm\FormProblema('idProblema');
                ...
                $context = new es\ucm\Context(FIND_PROBLEMA, htmlspecialchars(trim(strip_tags($_GET[$name]))));
                  ...
                  if($contextProblema->getEvent() === FIND_PROBLEMA_OK ){
                    $datosIniciales['Creditos']=$contextProblema->getData()->getCreditos();
                    $datosIniciales['Presencial']=$contextProblema->getData()->getPresencial();
