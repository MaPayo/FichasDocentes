                ...
                <div class="col-xl-6 col-lg-8 col-12">
                    <div class="card">
                        <div class="card-header text-center">
                            <h2>Cambiar información del perfil de <strong><?php echo $contextProfesor->getData()->getNombre()?></strong></h2>
                        </div>
                        <div class="card-body text-center">
                            <?php
                            $access = new es\ucm\FormInfo('Email');
                            $datosIniciales = array();
                            $datosIniciales['Email'] = $contextProfesor->getData()->getEmail();
                            $datosIniciales['Nombre'] = $contextProfesor->getData()->getNombre();
                            $datosIniciales['Departamento'] = $contextProfesor->getData()->getDepartamento();
                            $datosIniciales['Despacho'] = $contextProfesor->getData()->getDespacho();
                            $datosIniciales['Tutoria'] = $contextProfesor->getData()->getTutoria();
                            $datosIniciales['Facultad'] = $contextProfesor->getData()->getFacultad();
