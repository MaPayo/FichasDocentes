...
<head>
  ...
  ?>
  <title>Gestión Docente: Permitir Edición</title>
</head>
    ...
    <div class="row justify-content-center align-items-center">
      ...
      if (isset($_SESSION['login']) && $_SESSION['login'] === true) {
        if(isset($_GET['IdAsignatura']) && isset($_GET['IdGrado'])){
          ...
          if($contextAsignatura->getEvent() === FIND_ASIGNATURA_OK && ((isset($_SESSION['asignaturas'][$_GET['IdGrado']][$_GET['IdAsignatura']]['coordinacion']) && $_SESSION['asignaturas'][$_GET['IdGrado']][$_GET['IdAsignatura']]['coordinacion'] == true) || ($contextAsignatura->getData()->getCoordinadorAsignatura() == $_SESSION['idUsuario']))){
