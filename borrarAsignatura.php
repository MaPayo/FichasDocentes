                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if ($contextAsignatura->getEvent() === FIND_ASIGNATURA_OK) {
                                    $contextAsignatura->getData()->setActivo(0);
                  
                                    $context = new es\ucm\Context(DELETE_ASIGNATURA, $contextAsignatura->getData());
                                    $contextDA = $controller->action($context);
                                   if ($contextDA->getEvent() === DELETE_ASIGNATURA_OK) {
                                        header('Location: gestionAsignaturas.php');
                                    } elseif ($contextDA->getEvent() === DELETE_ASIGNATURA_FAIL) {
